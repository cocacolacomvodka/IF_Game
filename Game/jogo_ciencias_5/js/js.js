...
$(document).ready(function(){
        $.ajax({
            ...
            url: "http://localhost/Projeto_Game/Game_Educacional/php_pagina/logado.php",
            type: 'GET',
...
function exibePergunta(perg) {  // Início da função exibePergunta()
    ...
    $.ajax({
     url: "http://localhost/Projeto_Game/Game_Educacional/php_pagina/pergunta.php?pergunta=" + pergunta , 
     type: 'GET',
       success: function(data){          
            ...
            $.ajax({
              url: "http://localhost/Projeto_Game/Game_Educacional/php_pagina/resposta.php?pergunta=" + pergunta , 
              type: 'GET',
...
function troca_alternativa(){
    ...
    if ((contadorPergunta-2 >= 5) && (contadorPergunta-2 < 10)) {
            ...
            $('#alternativa2').css("background-size", "05px 50px");
...
function exibeScore() {  
    ...
    $.ajax({
     url: "http://localhost/Projeto_Game/Game_Educacional/php_pagina/gravar_score.php?placar=" + acertos , 
     type: 'GET',
       success: function(data){    
    ...
    $.ajax({
    //pegando a url apartir do href do link
     url: "http://localhost/Projeto_Game/Game_Educacional/php_pagina/exibe_score.php",
     type: 'GET',
        success: function(data){    
